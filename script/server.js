document.addEventListener('DOMContentLoaded', () => {
    ...
    class Manga {
        constructor(title, author, genre, status, category) {
            this.id = Date.now();
            this.title = title;
            this.author = author;
            this.genre = genre;
    ...
    mangaForm.addEventListener('submit', (event) => {
        ...
        const manga = new Manga(title, author, genre, status, category);
    ...
    window.editManga = (id) => {
        ...
        submitButton.onclick = (event) => {
            ...
            mangaForm.reset();
            submitButton.textContent = 'Adicionar Mangás';
    ...
    window.selectCategory = (category) => {
        ...
        categoryMenu.style.display = 'none'; // Oculta o menu após a seleção
    };

    // Oculta o menu de categorias se clicar fora dele
