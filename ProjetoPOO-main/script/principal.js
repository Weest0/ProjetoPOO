document.addEventListener('DOMContentLoaded', () => { //DOMContentLoaded para deixar um pouco mais fluido.
    ...
    class Manga {
        constructor(titulo, autor, ultimoCapituloLido, linkImagem, genero, status, categoria) {
            this._titulo = titulo;
            this._autor = autor;
            this._ultimoCapituloLido = ultimoCapituloLido;
            this._linkImagem = linkImagem;
            this._genero = genero;
            this._status = status;
        ...
        get ultimoCapituloLido() {
            return this._ultimoCapituloLido;
        }
    
        set ultimoCapituloLido(novoUltimoCapituloLido) {
            this._ultimoCapituloLido = novoUltimoCapituloLido;
        }
    
        get linkImagem() {
            return this._linkImagem;
        }
    
        set linkImagem(novoLinkImagem) {
            this._linkImagem = novoLinkImagem;
        }
